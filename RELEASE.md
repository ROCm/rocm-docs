...
The following issue has been resolved in the [AMD GPU Driver (amdgpu) 30.10.1](https://instinct.docs.amd.com/projects/amdgpu-docs/en/docs-30.10.1/documentation/release-notes.html#amd-gpu-driver-amdgpu-30-10-1-release-notes) to be used with ROCm 7.0.1.
...
Exceeding bad memory page threshold fails to declare Out-Of-Band Common Platform Error Records (CPERs). This issue affects all AMD Instinct MI300 Series and MI350 Series GPUs, and will be fixed in a future AMD GPU Driver release. See [GitHub issue #7882](https://github.com/ROCm/TheRock/issues/7882).
